...
/**
 * @file NutAngles.cpp
 * @brief Calculates the nutation in longitude and obliquity.
 *
 * @details This function calculates the nutation in longitude (dpsi) and obliquity (deps)
 * given the Modified Julian Date in Terrestrial Time (Mjd_TT).
 *
 * @param Mjd_TT Modified Julian Date (Terrestrial Time).
 * @param dpsi Nutation in longitude (radians).
 * @param deps Nutation in obliquity (radians).
 *
 * @return void
 *
...
void NutAngles(double Mjd_TT, double &dpsi, double &deps) {
    ...
    double T2 = T * T;
    double T3 = T2 * T;
    const double rev = 360 * 3600; // arcsec/revolution

    constexpr int N_coeff = 106;
    constexpr int C[N_coeff][9] = {
